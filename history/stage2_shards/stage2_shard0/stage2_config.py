...
class Stage2Config:
    ...
    stage1_model_path: str = '/home/ubuntu/data1/lyy/full_rlds_project-3/stage2/checkpoints/round_0_final'
    """Stage 1 SFT 模型路径"""
    
    save_dir: str = '/home/ubuntu/data1/lyy/full_rlds_project-3/stage2/checkpoints_shard0'
    """Stage 2 GSPO 模型保存目录"""
